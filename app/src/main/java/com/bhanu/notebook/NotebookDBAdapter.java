...
public class NotebookDBAdapter {
    ...
    //constructor of NotebookDBAdapter
    public NotebookDBAdapter(Context ctx){
        context = ctx;
    }

    // Now we need to implement method for opening and closing the database
    ...
    public ArrayList<Note> getAllNotes(){
        ...
        //loop through all the rows(notes) in our database and create newNote object from those rows
        // and add them to our array list
        ...
        // return array list now filled with database notes in database
        return notes;
    }

    // give a cursor return a note object
    ...
    private static class NotebookDbHelper extends SQLiteOpenHelper{
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion){
            ...
            db.execSQL("DROP TABLE IF EXITS " + NOTE_TABLE);
            onCreate(db);
        }
    }
